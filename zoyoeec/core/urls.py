...
# admin stuff
  ...
  (r'^admin/ebayconfig/$', 'admin.ebayconfig'),
  (r'^admin/addconfig/$', 'admin.addconfig'),
  (r'^admin/config/categories/$', 'admin.categories'),
